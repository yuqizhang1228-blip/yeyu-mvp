...
| [YUQ-37](https://linear.app/yuqi-design/issue/YUQ-37) | In Review | [设置 `226:2802`](https://www.figma.com/design/cGFZXtYVmzWIQ7XqybecGP/0515?node-id=226-2802)、[记忆偏好 `226:2825`](https://www.figma.com/design/cGFZXtYVmzWIQ7XqybecGP/0515?node-id=226-2825) | — | `PersonalizationView` | 视觉收口 ✅：分组圆角卡（记忆：开关+编辑你的记忆→；偏好自定义：沟通风格→占位）。手动记忆编辑移入二级 sheet；完整记忆管理列表属 YUQ-39 仍 v1 外 |
| [YUQ-38](https://linear.app/yuqi-design/issue/YUQ-38) | In Review | [关于夜屿 `226:2844`](https://www.figma.com/design/cGFZXtYVmzWIQ7XqybecGP/0515?node-id=226-2844) | — | `AboutView` | 视觉收口 ✅：月/山插画 + 诞生记 + 创始人故事原文（226:2866）+ 落款；安全合规热线脚注保留 |
